Shader "Custom/BlendLayersExample"
{
	Properties
	{
		...
		[Space(30)]
			...
			_Layer1Height("Layer 1 Height", Range(0, 3000)) = 1
		[Space(20)]
			_Layer2("Layer 2", 2D) = "white" {}
			_Layer2Height("Layer 2 Height", Range(0, 3000)) = 1
		[Space(20)]
			_Layer3("Layer 3", 2D) = "white" {}
			_Layer3Height("Layer 3 Height", Range(0, 3000)) = 1
	}
		SubShader
			{
				...
				{//Remove this layer's height from the total height so our next layer buids from it, but don't let it go below 0
					...
					float t = min(1, bd.height * (_BlendSharpness / 1000));
				...
				void surf(Input i, inout SurfaceOutputStandard o)
				{
					...
					blendingData bdata;
						...
						bdata.height = localPos.y - _BaseHeight;
